...
import com.porfolio.nicolasmonacoojeda.NicolasmonacoojedaApplication;
...
/**
 * AOT generated context for {@code NicolasmonacoojedaApplicationTests}.
 */
public class NicolasmonacoojedaApplicationTestsContextInitializer implements ApplicationContextInitializer<GenericApplicationContext> {
  ...
  public void initialize(GenericApplicationContext context) {
    ...
    BeanDefinitionRegistrar.of("nicolasmonacoojedaApplication", NicolasmonacoojedaApplication.class)
        .instanceSupplier(NicolasmonacoojedaApplication::new).register(beanFactory);
    org.springframework.boot.autoconfigure.NicolasmonacoojedaApplicationTestsContextInitializer.registerAutoConfigurationPackages_BasePackages(beanFactory);
    ...
    org.springframework.boot.autoconfigure.websocket.servlet.NicolasmonacoojedaApplicationTestsContextInitializer.registerWebSocketServletAutoConfiguration_TomcatWebSocketConfiguration(beanFactory);
    org.springframework.boot.autoconfigure.websocket.servlet.NicolasmonacoojedaApplicationTestsContextInitializer.registerTomcatWebSocketConfiguration_websocketServletWebServerCustomizer(beanFactory);
    ...
    org.springframework.boot.autoconfigure.web.servlet.NicolasmonacoojedaApplicationTestsContextInitializer.registerServletWebServerFactoryConfiguration_EmbeddedTomcat(beanFactory);
    org.springframework.boot.autoconfigure.web.servlet.NicolasmonacoojedaApplicationTestsContextInitializer.registerEmbeddedTomcat_tomcatServletWebServerFactory(beanFactory);
    ...
    org.springframework.boot.context.properties.NicolasmonacoojedaApplicationTestsContextInitializer.registerConfigurationPropertiesBinder_Factory(beanFactory);
    org.springframework.boot.context.properties.NicolasmonacoojedaApplicationTestsContextInitializer.registerConfigurationPropertiesBinder(beanFactory);
    ...
    org.springframework.boot.autoconfigure.web.servlet.NicolasmonacoojedaApplicationTestsContextInitializer.registerDispatcherServletAutoConfiguration_DispatcherServletConfiguration(beanFactory);
    org.springframework.boot.autoconfigure.web.servlet.NicolasmonacoojedaApplicationTestsContextInitializer.registerDispatcherServletConfiguration_dispatcherServlet(beanFactory);
    ...
    org.springframework.boot.autoconfigure.web.servlet.NicolasmonacoojedaApplicationTestsContextInitializer.registerDispatcherServletAutoConfiguration_DispatcherServletRegistrationConfiguration(beanFactory);
    org.springframework.boot.autoconfigure.web.servlet.NicolasmonacoojedaApplicationTestsContextInitializer.registerDispatcherServletRegistrationConfiguration_dispatcherServletRegistration(beanFactory);
    ...
    org.springframework.boot.autoconfigure.web.servlet.error.NicolasmonacoojedaApplicationTestsContextInitializer.registerErrorMvcAutoConfiguration_WhitelabelErrorViewConfiguration(beanFactory);
    org.springframework.boot.autoconfigure.web.servlet.error.NicolasmonacoojedaApplicationTestsContextInitializer.registerWhitelabelErrorViewConfiguration_error(beanFactory);
    org.springframework.boot.autoconfigure.web.servlet.error.NicolasmonacoojedaApplicationTestsContextInitializer.registerWhitelabelErrorViewConfiguration_beanNameViewResolver(beanFactory);
    org.springframework.boot.autoconfigure.web.servlet.error.NicolasmonacoojedaApplicationTestsContextInitializer.registerErrorMvcAutoConfiguration_DefaultErrorViewResolverConfiguration(beanFactory);
    org.springframework.boot.autoconfigure.web.servlet.error.NicolasmonacoojedaApplicationTestsContextInitializer.registerDefaultErrorViewResolverConfiguration_conventionErrorViewResolver(beanFactory);
    ...
    org.springframework.boot.autoconfigure.web.servlet.error.NicolasmonacoojedaApplicationTestsContextInitializer.registerErrorMvcAutoConfiguration_errorPageCustomizer(beanFactory);
    org.springframework.boot.autoconfigure.web.servlet.error.NicolasmonacoojedaApplicationTestsContextInitializer.registerErrorMvcAutoConfiguration_preserveErrorControllerTargetClassPostProcessor(beanFactory);
    org.springframework.boot.autoconfigure.web.servlet.NicolasmonacoojedaApplicationTestsContextInitializer.registerWebMvcAutoConfiguration_EnableWebMvcConfiguration(beanFactory);
    ...
    org.springframework.boot.autoconfigure.web.servlet.NicolasmonacoojedaApplicationTestsContextInitializer.registerEnableWebMvcConfiguration_welcomePageHandlerMapping(beanFactory);
    ...
    org.springframework.boot.autoconfigure.web.servlet.NicolasmonacoojedaApplicationTestsContextInitializer.registerWebMvcAutoConfiguration_WebMvcAutoConfigurationAdapter(beanFactory);
    ...
    org.springframework.boot.autoconfigure.aop.NicolasmonacoojedaApplicationTestsContextInitializer.registerAspectJAutoProxyingConfiguration_JdkDynamicAutoProxyConfiguration(beanFactory);
    ...
    org.springframework.boot.autoconfigure.aop.NicolasmonacoojedaApplicationTestsContextInitializer.registerAopAutoConfiguration_AspectJAutoProxyingConfiguration(beanFactory);
    ...
    org.springframework.boot.autoconfigure.jackson.NicolasmonacoojedaApplicationTestsContextInitializer.registerJacksonAutoConfiguration_Jackson2ObjectMapperBuilderCustomizerConfiguration(beanFactory);
    org.springframework.boot.autoconfigure.jackson.NicolasmonacoojedaApplicationTestsContextInitializer.registerJackson2ObjectMapperBuilderCustomizerConfiguration_standardJacksonObjectMapperBuilderCustomizer(beanFactory);
    ...
    org.springframework.boot.autoconfigure.jackson.NicolasmonacoojedaApplicationTestsContextInitializer.registerJacksonAutoConfiguration_JacksonObjectMapperBuilderConfiguration(beanFactory);
    org.springframework.boot.autoconfigure.jackson.NicolasmonacoojedaApplicationTestsContextInitializer.registerJacksonObjectMapperBuilderConfiguration_jacksonObjectMapperBuilder(beanFactory);
    org.springframework.boot.autoconfigure.jackson.NicolasmonacoojedaApplicationTestsContextInitializer.registerJacksonAutoConfiguration_ParameterNamesModuleConfiguration(beanFactory);
    org.springframework.boot.autoconfigure.jackson.NicolasmonacoojedaApplicationTestsContextInitializer.registerParameterNamesModuleConfiguration_parameterNamesModule(beanFactory);
    org.springframework.boot.autoconfigure.jackson.NicolasmonacoojedaApplicationTestsContextInitializer.registerJacksonAutoConfiguration_JacksonObjectMapperConfiguration(beanFactory);
    org.springframework.boot.autoconfigure.jackson.NicolasmonacoojedaApplicationTestsContextInitializer.registerJacksonObjectMapperConfiguration_jacksonObjectMapper(beanFactory);
    ...
    org.springframework.boot.autoconfigure.jdbc.NicolasmonacoojedaApplicationTestsContextInitializer.registerDataSourceConfiguration_Hikari(beanFactory);
    org.springframework.boot.autoconfigure.jdbc.NicolasmonacoojedaApplicationTestsContextInitializer.registerHikari_dataSource(beanFactory);
    org.springframework.boot.autoconfigure.jdbc.NicolasmonacoojedaApplicationTestsContextInitializer.registerDataSourceJmxConfiguration_Hikari(beanFactory);
    org.springframework.boot.autoconfigure.jdbc.NicolasmonacoojedaApplicationTestsContextInitializer.registerDataSourceJmxConfiguration(beanFactory);
    org.springframework.boot.autoconfigure.jdbc.NicolasmonacoojedaApplicationTestsContextInitializer.registerDataSourceAutoConfiguration_PooledDataSourceConfiguration(beanFactory);
    org.springframework.boot.autoconfigure.jdbc.metadata.NicolasmonacoojedaApplicationTestsContextInitializer.registerDataSourcePoolMetadataProvidersConfiguration_HikariPoolDataSourceMetadataProviderConfiguration(beanFactory);
    org.springframework.boot.autoconfigure.jdbc.metadata.NicolasmonacoojedaApplicationTestsContextInitializer.registerHikariPoolDataSourceMetadataProviderConfiguration_hikariPoolDataSourceMetadataProvider(beanFactory);
    ...
    org.springframework.boot.autoconfigure.orm.jpa.NicolasmonacoojedaApplicationTestsContextInitializer.registerJpaBaseConfiguration_JpaWebConfiguration(beanFactory);
    org.springframework.boot.autoconfigure.orm.jpa.NicolasmonacoojedaApplicationTestsContextInitializer.registerJpaWebConfiguration_openEntityManagerInViewInterceptor(beanFactory);
    org.springframework.boot.autoconfigure.orm.jpa.NicolasmonacoojedaApplicationTestsContextInitializer.registerJpaWebConfiguration_openEntityManagerInViewInterceptorConfigurer(beanFactory);
    org.springframework.boot.autoconfigure.orm.jpa.NicolasmonacoojedaApplicationTestsContextInitializer.registerHibernateJpaConfiguration(beanFactory);
    ...
    org.springframework.data.jpa.util.NicolasmonacoojedaApplicationTestsContextInitializer.registerJpaMetamodelCacheCleanup(beanFactory);
    ...
    org.springframework.boot.autoconfigure.http.NicolasmonacoojedaApplicationTestsContextInitializer.registerHttpMessageConvertersAutoConfiguration_StringHttpMessageConverterConfiguration(beanFactory);
    org.springframework.boot.autoconfigure.http.NicolasmonacoojedaApplicationTestsContextInitializer.registerStringHttpMessageConverterConfiguration_stringHttpMessageConverter(beanFactory);
    org.springframework.boot.autoconfigure.http.NicolasmonacoojedaApplicationTestsContextInitializer.registerJacksonHttpMessageConvertersConfiguration_MappingJackson2HttpMessageConverterConfiguration(beanFactory);
    org.springframework.boot.autoconfigure.http.NicolasmonacoojedaApplicationTestsContextInitializer.registerMappingJackson2HttpMessageConverterConfiguration_mappingJackson2HttpMessageConverter(beanFactory);
    org.springframework.boot.autoconfigure.http.NicolasmonacoojedaApplicationTestsContextInitializer.registerJacksonHttpMessageConvertersConfiguration(beanFactory);
    ...
    org.springframework.data.web.config.NicolasmonacoojedaApplicationTestsContextInitializer.registerProjectingArgumentResolverRegistrar_projectingArgumentResolverBeanPostProcessor(beanFactory);
    ...
    org.springframework.boot.autoconfigure.jdbc.NicolasmonacoojedaApplicationTestsContextInitializer.registerJdbcTemplateConfiguration(beanFactory);
    org.springframework.boot.autoconfigure.jdbc.NicolasmonacoojedaApplicationTestsContextInitializer.registerJdbcTemplateConfiguration_jdbcTemplate(beanFactory);
    org.springframework.boot.autoconfigure.jdbc.NicolasmonacoojedaApplicationTestsContextInitializer.registerNamedParameterJdbcTemplateConfiguration(beanFactory);
    org.springframework.boot.autoconfigure.jdbc.NicolasmonacoojedaApplicationTestsContextInitializer.registerNamedParameterJdbcTemplateConfiguration_namedParameterJdbcTemplate(beanFactory);
    ...
    org.springframework.boot.sql.init.dependency.NicolasmonacoojedaApplicationTestsContextInitializer.registerDatabaseInitializationDependencyConfigurer_DependsOnDatabaseInitializationPostProcessor(beanFactory);
    org.springframework.boot.autoconfigure.sql.init.NicolasmonacoojedaApplicationTestsContextInitializer.registerDataSourceInitializationConfiguration(beanFactory);
    org.springframework.boot.autoconfigure.sql.init.NicolasmonacoojedaApplicationTestsContextInitializer.registerDataSourceInitializationConfiguration_dataSourceScriptDatabaseInitializer(beanFactory);
    ...
    org.springframework.boot.autoconfigure.jdbc.NicolasmonacoojedaApplicationTestsContextInitializer.registerDataSourceTransactionManagerAutoConfiguration_JdbcTransactionManagerConfiguration(beanFactory);
    ...
    org.springframework.transaction.annotation.NicolasmonacoojedaApplicationTestsContextInitializer.registerProxyTransactionManagementConfiguration(beanFactory);
    ...
    org.springframework.boot.autoconfigure.web.servlet.NicolasmonacoojedaApplicationTestsContextInitializer.registerHttpEncodingAutoConfiguration_localeCharsetMappingsCustomizer(beanFactory);
