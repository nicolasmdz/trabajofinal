...
public class TestContextBootstrapInitializer {
  public static Map<String, Supplier<SmartContextLoader>> getContextLoaders() {
    ...
    entries.put("com.porfolio.nicolasmonacoojeda.NicolasmonacoojedaApplicationTests", () -> new AotSpringBootConfigContextLoader(NicolasmonacoojedaApplicationTestsContextInitializer.class, WebApplicationType.SERVLET, SpringBootTest.WebEnvironment.MOCK));
    return entries;
  }
  ...
  public static Map<String, Class<? extends ApplicationContextInitializer<?>>> getContextInitializers(
    ...
    entries.put("com.porfolio.nicolasmonacoojeda.NicolasmonacoojedaApplicationTests", NicolasmonacoojedaApplicationTestsContextInitializer.class);
    return entries;
  }
}
